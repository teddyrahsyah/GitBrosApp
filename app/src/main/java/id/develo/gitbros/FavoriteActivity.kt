...
class FavoriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickCallback(object : FavUserAdapter.OnItemClickCallback {
            override fun onItemClicked(userUrl: String?) {
                val intentToDetail = Intent(this@FavoriteActivity, DetailActivity::class.java)
                intentToDetail.putExtra(DetailActivity.EXTRA_Detail, userUrl)
                startActivity(intentToDetail)
                Log.d("TEST STATUS", userUrl.toString())
            }

            override fun onItemRemoveClicked(uriWithId: Uri) {
